...
const blogs: Blog[] = [
  ...
  { id: 5, title: 'Why the Current Generation is More Prone to Lifestyle Disorders', excerpt: "In today's fast-paced world, lifestyle disorders have become increasingly common, particularly among the younger generation. Factors such as sedentary behavior, poor dietary choices, and high-stress levels contribute significantly to this troubling trend.", link: '/blog5', image: '/blogsimg.png' },
  { id: 6, title: 'Why the Current Generation is More Prone to Lifestyle Disorders', excerpt: "In today's fast-paced world, lifestyle disorders have become increasingly common, particularly among the younger generation. Factors such as sedentary behavior, poor dietary choices, and high-stress levels contribute significantly to this troubling trend.", link: '/blog6', image: '/blogsimg.png' },
  { id: 7, title: 'Why the Current Generation is More Prone to Lifestyle Disorders', excerpt: "In today's fast-paced world, lifestyle disorders have become increasingly common, particularly among the younger generation. Factors such as sedentary behavior, poor dietary choices, and high-stress levels contribute significantly to this troubling trend.", link: '/blog7', image: '/blogsimg.png' }
];
